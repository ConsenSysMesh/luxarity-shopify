...
const node = new IPFS();
    ...
    node.on('ready', async () => {
      ...
      var orderjson = await fetch('https://a2cb93368c968029e8ffdf925ab3f4f6:10d3c4d7bef29c260283452aad702c18@luxarity-test.myshopify.com/admin/orders.json?ids=693655208047')
        .then(res => res.json())
